...
namespace Elements
{
    ...
    /// <summary>Represents the Lat, Lon coordinates of the world 0,0, to specify geographical information for a project.</summary>
    ...
    public partial class Origin : Element
    {
        ...
        /// <summary>The latitude and longitude of the origin.</summary>
        [JsonProperty("Position", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [JsonProperty("Transform", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
