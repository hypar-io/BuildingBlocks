...
namespace RoofFunction
{
    ...
    
    {
        ...
        public RoofFunctionInputs(Color @roofColor, double @roofThickness, double @insulationThickness, bool @changeRoofLevel, Color @insulationColor, string bucketName, string uploadsBucket, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
        base(bucketName, uploadsBucket, modelInputKeys, gltfKey, elementsKey, ifcKey)
        {
            var validator = Validator.Instance.GetFirstValidatorForType<RoofFunctionInputs>();
            if(validator != null)
            {
                validator.PreConstruct(new object[]{ @roofColor, @roofThickness, @insulationThickness, @changeRoofLevel, @insulationColor});
            }
        
            this.RoofColor = @roofColor;
            this.RoofThickness = @roofThickness;
            this.InsulationThickness = @insulationThickness;
            this.ChangeRoofLevel = @changeRoofLevel;
        ...
        [Newtonsoft.Json.JsonProperty("Change Roof Level", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool ChangeRoofLevel { get; set; } = false;
