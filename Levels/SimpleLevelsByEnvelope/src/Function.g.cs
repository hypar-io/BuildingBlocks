...
namespace SimpleLevelsByEnvelope
{
    public class Function
    {
        ...
        private UrlModelStore<SimpleLevelsByEnvelopeInputs> store;

        public async Task<SimpleLevelsByEnvelopeOutputs> Handler(SimpleLevelsByEnvelopeInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<SimpleLevelsByEnvelopeInputs>();
            }
