...
namespace Site
{
	public class SiteInputs: S3Args
	{
		...
		/// <returns></returns>
		[JsonConstructor]
		public SiteInputs(Feature[] lot, double sitesetback, double buildinglength, double buildingwidth, double searchgridresolution, double searchseed, string bucketName, string uploadsBucket, string gltfKey, string elementsKey, string ifcKey): base(bucketName, uploadsBucket, gltfKey, elementsKey, ifcKey)
		{
			this.Lot = lot;
