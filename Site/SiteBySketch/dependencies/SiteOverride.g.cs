...
{
	/// <summary>
	/// Override metadata for SiteOverride
	/// </summary>
	public partial class SiteOverride : IOverride
	{
	...
	public static class SiteOverrideExtensions
    {
		/// <summary>
        /// Apply Site edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Site Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<SiteOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, SiteIdentity, bool> identityMatch,
            Func<T, SiteOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Site Overrides to apply — typically `input.Overrides.Site`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<SiteOverride> overrideData,
            Func<T, SiteIdentity, bool> identityMatch,
            Func<T, SiteOverride, T> modifyElement
            ) where T : Element
        {
        ...
        /// </summary>
        /// <param name="edits">The collection of edit overrides (Overrides.Site)</param>
        /// <param name="additions">The collection of add overrides (Overrides.Additions.Site)</param>
        /// <param name="removals">The collection of remove overrides (Overrides.Removals.Site)</param>        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        ...
        public static List<T> CreateElements<T>(
            this IList<SiteOverride> edits,
            IList<SiteOverrideAddition> additions,
            IList<SiteOverrideRemoval> removals,            Func<SiteOverrideAddition, T> createElement,
            Func<T, SiteIdentity, bool> identityMatch,
            Func<T, SiteOverride, T> modifyElement,
