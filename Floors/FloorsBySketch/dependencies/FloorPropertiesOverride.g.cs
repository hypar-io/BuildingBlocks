...
{
	/// <summary>
	/// Override metadata for FloorPropertiesOverride
	/// </summary>
	public partial class FloorPropertiesOverride : IOverride
	{
        public static string Name = "Floor Properties";
	...
	public static class FloorPropertiesOverrideExtensions
    {
		/// <summary>
        /// Apply Floor Properties edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Floor Properties Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<FloorPropertiesOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, FloorPropertiesIdentity, bool> identityMatch,
            Func<T, FloorPropertiesOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Floor Properties Overrides to apply — typically `input.Overrides.FloorProperties`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<FloorPropertiesOverride> overrideData,
            Func<T, FloorPropertiesIdentity, bool> identityMatch,
            Func<T, FloorPropertiesOverride, T> modifyElement
            ) where T : Element
        {
