...
namespace Elements
{
    ...
    
    {
        ...
        public RoomDefinition(string @suiteName, string @suiteNumber, string @roomDepartment, string @roomName, double @roomQuantity, double @roomArea, double @roomDimensionRatio, double @roomHeight, System.Guid @id, string @name)
            : base(id, name)
        {
