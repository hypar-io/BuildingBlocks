...
namespace Rooms
{
    public class Function
    {
        ...
        private IModelStore<RoomsInputs> store;

        public async Task<RoomsOutputs> Handler(RoomsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<RoomsInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<RoomsInputs,RoomsOutputs>(store, Rooms.Execute);
