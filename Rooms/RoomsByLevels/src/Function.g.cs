...
namespace RoomsByLevels
{
    public class Function
    {
        ...
        private IModelStore<RoomsByLevelsInputs> store;

        public async Task<RoomsByLevelsOutputs> Handler(RoomsByLevelsInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<RoomsByLevelsInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }
