...
{
	/// <summary>
	/// Override metadata for FacadeTypeSettingsOverride
	/// </summary>
	public partial class FacadeTypeSettingsOverride : IOverride
	{
        public static string Name = "Facade Type Settings";
