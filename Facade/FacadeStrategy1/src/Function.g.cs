...
namespace FacadeStrategy1
{
    public class Function
    {
        ...
        private IModelStore<FacadeStrategy1Inputs> store;

        public async Task<FacadeStrategy1Outputs> Handler(FacadeStrategy1Inputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<FacadeStrategy1Inputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<FacadeStrategy1Inputs,FacadeStrategy1Outputs>(store, FacadeStrategy1.Execute);
