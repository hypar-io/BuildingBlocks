...
namespace FacadeGrid
{
    public class Function
    {
        ...
        private IModelStore<FacadeGridInputs> store;

        public async Task<FacadeGridOutputs> Handler(FacadeGridInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<FacadeGridInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<FacadeGridInputs,FacadeGridOutputs>(store, FacadeGrid.Execute);
