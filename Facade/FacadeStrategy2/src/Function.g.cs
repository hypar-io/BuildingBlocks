...
namespace FacadeStrategy2
{
    public class Function
    {
        ...
        private IModelStore<FacadeStrategy2Inputs> store;

        public async Task<FacadeStrategy2Outputs> Handler(FacadeStrategy2Inputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<FacadeStrategy2Inputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<FacadeStrategy2Inputs,FacadeStrategy2Outputs>(store, FacadeStrategy2.Execute);
